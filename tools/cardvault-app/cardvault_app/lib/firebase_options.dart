// Firebase config — uses shared charlotte-substrate project.
// Replace with dedicated CardVault Firebase project when provisioned.
...
class DefaultFirebaseOptions {
  ...
  static const ios = FirebaseOptions(
    ...
    projectId: 'charlotte-substrate',
    storageBucket: 'charlotte-substrate.firebasestorage.app',
    iosBundleId: 'com.someai.cardvault',
  );
}
